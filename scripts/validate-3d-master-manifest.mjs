...
if(manifest.version<3) throw new Error("3D master manifest must use version 2+");
if(manifest.sourceOfTruth!=="svg/flat") throw new Error("3D source of truth must be svg/flat");
if(manifest.pipeline!=="canonical-flat-svg -> silhouette-volume -> curved-feature-geometry -> PBR-studio-render") throw new Error("Unexpected 2D -> 3D pipeline");
