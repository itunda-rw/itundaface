...
if(manifest.pipeline!=="canonical-flat-svg -> silhouette-classified-volume -> rounded-face-or-beveled-object -> shared-camera-render") throw new Error("Unexpected 2D -> 3D pipeline");
