...
export function ReactionIcon({ kind, size = 24, 'aria-label': ariaLabel, ...props }: ReactionIconProps & { kind: ReactionKind }) {
  return <svg width={size} height={size} viewBox="0 0 80 80" role="img" aria-label={ariaLabel ?? labels[kind]} {...props}>
    ...
    {kind === 'wow' && <><circle cx="40" cy="40" r="34" fill={face}/><circle cx="25.5" cy="34" r="5.2" fill={ink}/><circle cx="54.5" cy="34" r="5.2" fill={ink}/><ellipse cx="40" cy="55.5" rx="9" ry="11" fill={inkSoft}/><path d="M40 43.8v5" fill="none" stroke={brand} strokeWidth="3" strokeLinecap="round"/></>}
    {kind === 'sad' && <><circle cx="40" cy="40" r="34" fill={face}/><path d="M18.5 31.5c3.2 4.5 8.5 4.6 12.4.4" fill="none" stroke={ink} strokeWidth="4.2" strokeLinecap="round"/><path d="M49.1 31.9c3.9 4.2 9.2 4.1 12.4-.4" fill="none" stroke={ink} strokeWidth="4.2" strokeLinecap="round"/><path d="M26.8 61.2c3.1-6.2 7.6-9 13.2-9s10.1 2.8 13.2 9" fill="none" stroke={inkSoft} strokeWidth="4.2" strokeLinecap="round"/><path d="M49 40.8c3 3.5 4.8 7.1 4.8 10.5 0 4-2.5 6.6-5.6 6.6s-5.6-2.6-5.6-6.6c0-3.4 1.9-7 6.4-10.5Z" fill={brand}/></>}
  </svg>;
}
