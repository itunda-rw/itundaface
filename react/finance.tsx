...
export function FinanceIcon({ kind, size = 24, 'aria-label': ariaLabel, ...props }: FinanceIconProps & { kind: FinanceKind }) {
  ...
  if (kind === 'mobile-money') return <svg {...a}><rect x="21" y="10" width="38" height="60" rx="8" fill={brand}/><rect x="26" y="17" width="28" height="42" rx="4" fill={white}/><path d="M34 27h12M34 35h12M34 43h7" stroke={brand} strokeWidth="3" strokeLinecap="round"/><circle cx="40" cy="64" r="2.5" fill={face}/></svg>;
  if (kind === 'wallet') return <svg {...a}><path d="M12 24c0-4 3-7 7-7h40c5 0 9 4 9 9v32c0 4-3 7-7 7H19c-4 0-7-3-7-7V24Z" fill={brand}/><path d="M18 28h48v28H18c-3 0-5-2-5-5V33c0-3 2-5 5-5Z" fill={white}/><path d="M50 35h16v12H50c-4 0-7-3-7-6s3-6 7-6Z" fill={face}/><circle cx="52" cy="41" r="2" fill={ink}/></svg>;
  if (kind === 'bill-payment') return <svg {...a}><path d="M20 10h40v60l-7-5-7 5-6-5-6 5-7-5-7 5V10Z" fill={white} stroke={brand} strokeWidth="4" strokeLinejoin="round"/><path d="M29 25h22M29 35h22M29 45h14" stroke={brand} strokeWidth="4" strokeLinecap="round"/><circle cx="52" cy="51" r="7" fill={successSurface}/><path d="m48.5 51 2.5 2.5 4.5-5" fill="none" stroke={success} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg>;
  if (kind === 'airtime') return <svg {...a}><rect x="17" y="13" width="46" height="54" rx="8" fill={brand}/><rect x="23" y="21" width="34" height="30" rx="4" fill={white}/><path d="M31 36h18M40 27v18" stroke={face} strokeWidth="5" strokeLinecap="round"/><circle cx="40" cy="59" r="2.5" fill={face}/></svg>;
  if (kind === 'merchant-payment') return <svg {...a}><path d="M16 30h48l-4-13H20l-4 13Z" fill={brand}/><path d="M18 30v28c0 4 3 7 7 7h30c4 0 7-3 7-7V30" fill={white} stroke={brand} strokeWidth="4"/><path d="M28 47h24" stroke={brand} strokeWidth="4" strokeLinecap="round"/><circle cx="40" cy="47" r="7" fill={face}/></svg>;
  if (kind === 'transport-payment') return <svg {...a}><path d="M19 58V28c0-8 8-13 21-13s21 5 21 13v30" fill={brand}/><rect x="25" y="28" width="30" height="20" rx="4" fill={white}/><circle cx="27" cy="57" r="5" fill={face}/><circle cx="53" cy="57" r="5" fill={face}/><path d="M31 38h18M40 31v13" stroke={ink} strokeWidth="3.5" strokeLinecap="round"/></svg>;
  ...
  if (kind === 'government-payment') return <svg {...a}><path d="M15 29h50L40 15 15 29Z" fill={brand}/><path d="M20 34h40v25H20z" fill={white} stroke={brand} strokeWidth="4"/><path d="M28 38v17M40 38v17M52 38v17M14 63h52" stroke={ink} strokeWidth="4" strokeLinecap="round"/></svg>;
  if (kind === 'send') return <svg {...a}><path d="M10 39 68 12 47 68 36 45Z" fill={brand}/><path d="M36 45 68 12" stroke={white} strokeWidth="4" strokeLinecap="round"/><path d="m18 37 18 8" stroke={face} strokeWidth="4" strokeLinecap="round"/></svg>;
  ...
  if (kind === 'qr-payment') return <svg {...a}><rect x="10" y="10" width="60" height="60" rx="10" fill={white} stroke={brand} strokeWidth="4"/><path d="M20 20h18v18H20zM44 20h16v16H44zM20 44h16v16H20z" fill={ink}/><path d="M44 44h7v7h-7zM54 44h6v16h-6zM44 54h7v6h-7z" fill={brand}/></svg>;
  ...
  if (kind === 'receipt') return <svg {...a}><path d="M19 10h42v60l-7-5-7 5-7-5-7 5-7-5-7 5Z" fill={white} stroke={brand} strokeWidth="5" strokeLinejoin="round"/><path d="M29 25h22M29 34h16M29 43h22M29 52h11" stroke={brand} strokeWidth="4" strokeLinecap="round"/></svg>;
  return <svg {...a}><circle cx="40" cy="40" r="28" fill={white} stroke={brand} strokeWidth="6"/><path d="M40 24v17l11 7" fill="none" stroke={brand} strokeWidth="6" strokeLinecap="round" strokeLinejoin="round"/><path d="M19 31 12 39l7 8" fill="none" stroke={face} strokeWidth="5" strokeLinecap="round" strokeLinejoin="round"/></svg>;
}
